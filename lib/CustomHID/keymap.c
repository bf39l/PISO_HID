...
uint32_t keymaps[MAX_LAYERS][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    {
        {
            KC_GRAVE,                                   KC_1, KC_2, KC_3, KC_4, KC_5, TO(1),          MT(MD_LCTRL | MD_LSHIFT | MD_LALT, KC_ESC),      KC_6, KC_7, KC_8,     KC_9,   KC_0,      KC_MINUS,
            ...
            KC_LCTRL,       KC_LALT,         KC_LGUI,                MT(1, KC_SPACE), KC_BSPACE,      TG(3), MT(2, KC_SPACE), KC_RGUI, KC_RALT, KC_RCTRL
        }
    },
    // --- Layer 1: QWERTY ---
    {
        {
            KC_GRAVE,                                   KC_1, KC_2, KC_3, KC_4, KC_5, TO(0),          MT(MD_LCTRL | MD_LSHIFT | MD_LALT, KC_ESC),      KC_6, KC_7, KC_8,     KC_9,   KC_0,      KC_MINUS,
    ...
    {
        {
            ...
            KC_NO,   KC_NO,    KC_NO,                        KC_NO,   KC_NO,      TG(3),   KC_NO, KC_NO, KC_NO, KC_NO
        }
    },
    // --- Layer 0: Base ---
    // {

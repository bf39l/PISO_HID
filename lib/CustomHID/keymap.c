...
uint32_t keymaps[MAX_LAYERS][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    {
        {
            KC_GRAVE,  KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_TRNS,           KC_F12,    KC_F6,    KC_F7,                KC_F8,    KC_F9,                 KC_F10,  KC_F11,
            ...
            KC_TRNS,   KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,                                  KC_TRNS,  CH(MD_LGUI, KC_LEFT), KC_TRNS,  CH(MD_LGUI, KC_RIGHT), KC_TRNS, KC_TRNS,

...
uint32_t keymaps[MAX_LAYERS][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    {
        {
            KC_GRAVE,                                   KC_1, KC_2, KC_3, KC_4, KC_5, MT(MD_LCTRL | MD_LSHIFT | MD_LALT | MD_LGUI, KC_ESC),     TO(1),     KC_6, KC_7, KC_8,     KC_9,   KC_0,      KC_MINUS,
    ...
    {
        {
            KC_GRAVE,                                   KC_1, KC_2, KC_3, KC_4, KC_5, MT(MD_LCTRL | MD_LSHIFT | MD_LALT | MD_LGUI, KC_ESC),     TO(0),     KC_6, KC_7, KC_8,     KC_9,   KC_0,      KC_MINUS,
    ...
    {
        {
            ...
            KC_TRNS,   KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,           KC_PGUP,   KC_HOME, CH(MD_LALT, KC_LEFT), KC_UP,    CH(MD_LALT, KC_RIGHT), KC_TRNS, KC_TRNS,
